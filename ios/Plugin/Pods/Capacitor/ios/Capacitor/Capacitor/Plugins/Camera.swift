...
public class Camera: CAPPlugin, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate {
    ...
    @objc func getPhoto(_ call: CAPPluginCall) {
        ...
        alert.addAction(UIAlertAction(title: "From Photos", style: .default, handler: { (_: UIAlertAction) in
        ...
        alert.addAction(UIAlertAction(title: "Take Picture", style: .default, handler: { (_: UIAlertAction) in
